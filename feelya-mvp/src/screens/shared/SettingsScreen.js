...
import { Screen, Header, SecondaryButton, SafetyBanner, Card, Divider } from '../../components/UI';
...
const styles = StyleSheet.create({
  ...
  scroll: { padding: spacing.screenPadding, paddingTop: spacing.md },
  card: { marginBottom: spacing.md },
  label: { fontSize: font.caption, color: colors.textMuted, marginBottom: 4 },
  ...
  resetBtn: { marginBottom: spacing.xxl },
});
